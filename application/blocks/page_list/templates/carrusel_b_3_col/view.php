...
<script>
   $(document).on('ready', function() {
      $(".page-list-stick-b").removeClass("hidden");
      $(".page-list-plantilla-slick-b-loading").addClass("hidden");
      $(".page-list-stick-b").slick({
        adaptiveHeight: true,
        arrows: true,
        dots: true,        
	autoplay: true,
...
<div class="page-list-plantilla-slick-b-loading" style="height:400px; text-align: center; vertical-align:center; padding-top:50px;">...</div>
<div class="page-list-stick-b slider lazy page-list-plantilla-slick-b hidden">
