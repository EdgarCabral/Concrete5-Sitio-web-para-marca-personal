...
<script>
   $(document).on('ready', function() {
      $(".vertical-center-4").removeClass("hidden");
      $(".plantilla-slick-2-loading").addClass("hidden");
...
<div class="stick-image-slider-<?=$navigationTypeText; ?>" >
    <div class="plantilla-slick-2-loading" style="height:400px; text-align: center; vertical-align:center; padding-top:50px;">...</div>
    <?php if (count($rows) > 0) { ?>
        <section class="vertical-center-4 slider lazy plantilla-slick-2 hidden" id="stick-image-slider-<?php echo $bID; ?>">
