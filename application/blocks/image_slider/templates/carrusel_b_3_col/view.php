...
<script>
   $(document).on('ready', function() {
      $(".vertical-center-3").removeClass("hidden");
      $(".plantilla-slick-3-loading").addClass("hidden");
...
<div class="stick-image-slider-<?=$navigationTypeText; ?>" >
    <div class="plantilla-slick-3-loading" style="height:400px; text-align: center; vertical-align:center; padding-top:50px;">...</div>
    <?php if (count($rows) > 0) { ?>
        <section class="vertical-center-3 slider lazy plantilla-slick-3 hidden" id="stick-image-slider-<?php echo $bID; ?>">
